...
def generate_conversation(topic, history_path, output_dir, full_output_dir, max_user_turns, planner_model, attacker_model, victim_model, planner_prompt_version="current", attacker_prompt_version="current"):
...
def main(topic, num_conversations, output_dir='data', full_output_dir='full_responses', max_workers=25, max_user_turns=10, planner_model="deepseek-ai/DeepSeek-V3", attacker_model="deepseek-ai/DeepSeek-V3", victim_model="deepseek-ai/DeepSeek-V3", planner_prompt_version="current", attacker_prompt_version="current"):
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        futures = {executor.submit(generate_conversation, topic, history_path, output_dir, full_output_dir, max_user_turns, planner_model, attacker_model, victim_model, planner_prompt_version, attacker_prompt_version): i for i, (topic, history_path) in enumerate(zip(topics, history_paths))}
