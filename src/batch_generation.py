...
def generate_conversation(topic, history_path, output_directory, full_response_output_directory, max_user_turns, planner_model, attacker_model, victim_model, planner_prompt_version="current", attacker_prompt_version="current"):
    ...
    Args:
        ...
        output_directory (str): The directory to save the generated conversation output.
        full_response_output_directory (str): The directory to save full model responses.
    ...
    generator = ConversationGenerator(
        ...
        full_response_output_directory=full_response_output_directory,
...
def main(topic, num_conversations, output_directory='data', full_response_output_directory='full_responses', max_workers=25, max_user_turns=10, planner_model="deepseek-ai/DeepSeek-V3", attacker_model="deepseek-ai/DeepSeek-V3", victim_model="deepseek-ai/DeepSeek-V3", planner_prompt_version="current", attacker_prompt_version="current"):
    ...
    Args:
        ...
        output_directory (str, optional): Directory to save the generated conversations. Defaults to 'data'.
        full_response_output_directory (str, optional): Directory to save full model responses. Defaults to 'full_responses'.
    ...
    os.makedirs(full_response_output_directory, exist_ok=True)
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        futures = {executor.submit(generate_conversation, topic, history_path, output_directory, full_response_output_directory, max_user_turns, planner_model, attacker_model, victim_model, planner_prompt_version, attacker_prompt_version): i for i, (topic, history_path) in enumerate(zip(topics, history_paths))}
